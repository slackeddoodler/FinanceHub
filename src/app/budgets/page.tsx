...
export default function BudgetsPage() {
  ...
  if (userRole === "revoked" && !isPersonal) {
    return (
      <main className="min-h-screen bg-background p-8 flex flex-col">
        <GlobalHeader title="Company Workspace" subtitle="Access Suspended" activePage="budgets" handleDataRefresh={() => {}} />
  ...
  return (
    <main className="min-h-screen bg-background text-foreground p-8 space-y-6 pb-24">
      <GlobalHeader title="Company Budgets" subtitle="Manage cross-departmental allocations." activePage="budgets" handleDataRefresh={handleDataRefresh} />
